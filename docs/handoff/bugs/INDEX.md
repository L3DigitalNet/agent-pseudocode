...
| --- | --- | --- | --- | --- |
| 001 | 2026-07-09 | MCP resource map references docs/\*.md paths that never existed | mcp | fixed |
| 002 | 2026-07-09 | apseudo-review completeness checks hard-code stale docs/usage and docs/roadmap paths | review | fixed |
| 003 | 2026-07-09 | pre-migration ChatGPT transcript trips real APSEUDO lint errors on illustrative fences | lint | fixed |
