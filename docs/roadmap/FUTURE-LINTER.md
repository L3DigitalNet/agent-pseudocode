...
See `docs/reference/enforcement/ENFORCEMENT.md` for the rule set, install steps, pre-commit integration, GitHub Actions workflow, and Claude/Codex hook behavior.
